...
- Install image: `artifacts/LocketHUD-0.1.3-arm64.dmg`
- DMG size: 2,365,022 bytes
- DMG SHA-256: `63362c3ceac387eeff5074e0cbc7b8c8d8376bfa0f4b004d7e46bf4bdbbdbaa9`
...
4. Select a PNG, JPEG, HEIC, WebP, TIFF, or animated GIF image.
...
7. Press “发送到眼镜”. The editor pushes a processed PNG or animated GIF to app-specific storage and launches the display Activity with whitelisted parameters.
...
hdiutil verify "src-tauri/target/release/bundle/dmg/乐奇相片hud_0.1.3_aarch64.dmg"
```

- TypeScript/Vite production build: pass.
- Rust unit tests: 4/4 pass, including two-frame GIF processing and re-encoding.
